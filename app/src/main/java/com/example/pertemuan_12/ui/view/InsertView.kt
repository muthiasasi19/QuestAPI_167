...
import com.example.pertemuan_12.ui.viewModel.InsertUiEvent
import com.example.pertemuan_12.ui.viewModel.InsertUiState
import com.example.pertemuan_12.ui.viewModel.InsertViewModel
...
fun EntryBody(
    ...
    Column(
        ...
        Button(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .background(Color.DarkGray) // Warna latar belakang tombol
        ) {
            Text(
                text = "Simpan",
